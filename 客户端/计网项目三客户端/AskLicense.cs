...
namespace 计网项目三客户端
{
    ...
    {
        private static IPEndPoint ip2 = new IPEndPoint(IPAddress.Parse("192.168.18.3"), 8910);
        private static IPEndPoint ip3 = new IPEndPoint(IPAddress.Parse("192.168.18.3"), 8888);
